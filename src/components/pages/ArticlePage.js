        ...
        return (
          <>
            <div className={"App " + author.themePref + "-accent"}>
                ...
                <Main users={users} isLoggedIn={isLoggedIn} fetchArticle={fetchArticle} findUser={findUser} errorMessage={errorMessage} userInfo={author} landing={false} article={article} articles={author.articles} theme={author.themePref} layout={author.layoutPref} isAdmin={isAdmin} page={"article"}/>
